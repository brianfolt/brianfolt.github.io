...
Name = c("Conecuh National Forest, Alabama","Yunnan Province, China","Lower Canyons of the Rio Grande","Blue Ridge Mountains","Spring Creek, Georgia","La Selva Biological Station, Costa Rica","Conger Mountain, Utah")

Topic = c("Field studies of Gopher Tortoise survival and population genetic structure","Biodiversity surveys of reptiles and bats in karst caves","Formative wilderness adventure","Phylogenetic studies of salamanders","Demographic studies of Alligator Snapping Turtles","Field studies and experimental manipulations of frog and lizard population regulation","Feral horse demographic research")
