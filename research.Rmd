...
My work is **collaborative** in nature and I rely on diverse **teams** of students, post-docs, scientists, cooperating experts, and decision makers. Together, we create well-rounded teams that work together to understand problems, build products, and communicate **actionable science** to decision makers.

Click on the **bold topics** below to explore a few '**Case Studies**' highlighting how my work has supported management decisions for endangered species and ecosystems.
...
<img src="images/jwm-cover.jpg" style="width:25%; border:2px solid; margin-left: 15px" align="right">
...
### **Endangered Snake Reintroduction**
</div>

<div class="collapse" id="reintroduction">
<img src="images/indigo.jpg" style="width:30%; border:2px solid; margin-left: 15px" align="right">
...
<img src="images/indigo-release.jpg" style="width:30%; border:2px solid; margin-left: 15px" align="right">
