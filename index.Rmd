...
I currently work as an ecologist for the [U.S. Geological Survey](https://www.usgs.gov/) at the [Fort Collins Science Center](https://www.usgs.gov/centers/fort), where I am building tools to support management decisions for feral horse populations (i.e., 'wild horses') in the United States. I recently developed [*PopEquus*](https://rconnect.usgs.gov/popequus/), a website application that can be used to simulate wild horse populations and understand trade-offs in population management.
